...
async function playlist() {
    ...
    function get_list() {
        ...
        var indie_kpop_num = randombetween(
            1,
            max - oversea_num - main_kpop_num - 2
        );
        var indie_pop_num = randombetween(
            1,
            max - main_kpop_num - oversea_num - indie_kpop_num - 1
        );
        var classic_num =
            max - oversea_num - main_kpop_num - indie_kpop_num - indie_pop_num;
    ...
    return new Promise((resolve, reject) => {
        ...
        context.fillText(
            today_text,
            padding,
            y_position - text_space_height * 4
        );
        ...
        for (let i = 0; i < song_list.length; i++) {
            ...
            context.fillText(
                '*' + artist,
                title_xpos + 20,
                y_position + text_space_height * 0.9,
                300
            );
        ...
        // CARD 번호 인증번호 넣기
        context.font = font_artist;
        var card_str = 'CARD # : ************' + random4digit();
        var auth_str = 'AUTH CODE : ' + random3digit();
        ...
        // 바코드 넣기
        loadImage('./images/barcode.jpeg').then((image) => {
            ...
            loadImage('./images/logo.jpeg').then((image) => {
